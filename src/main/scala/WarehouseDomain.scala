...
//
//    def boxInLocation(location: Location, box: Box,  bigBoxAisle: AisleMap, littleBoxAisle: AisleMap): Option[Transport] = ???
//
//  }
//}
...
//    se ubicaran las cajas con productos de alta rotación y las cajas con productos de baja rotación seran ubicadas
//    en las celdas mas lejanas.
//    En momentos en que hay un gran flujo de entradas cambiaremos a un algoritmo que escoje la celda más cercana a la
//    pickup. En este caso priorizamos la rapidez de entrada frente a la localización óptima para la salida.

//    Refactorizar boxInLocation con un patrón strategy para manejar distintos algoritmos de ubicación en estantería.
